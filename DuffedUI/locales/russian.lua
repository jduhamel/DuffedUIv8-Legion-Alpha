...
if D.Client == "ruRU" then
	L["move"] = {
		...
		["shapeshift"] = "Переместить Shapeshift/Totem",
		["achievements"] = "Переместить Achievements",
		["roll"] = "Переместить Loot Roll Frame",
		["vehicle"] = "Переместить Vehicle Seat",
		...
		["bar5_1"] = "Переместить\nBar 5",
		["pet"] = "Переместить\nPet",
		["player"] = "Переместить Playercastbar",
		["target"] = "Переместить Targetcastbar",
		["classbar"] = "Переместить Classbar",
