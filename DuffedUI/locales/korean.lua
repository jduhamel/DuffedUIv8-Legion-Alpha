...
if D.Client == "koKR" then
	L["move"] = {
		...
		["shapeshift"] = "이동 Shapeshift/Totem",
		["achievements"] = "이동 Achievements",
		["roll"] = "이동 Loot Roll Frame",
		["vehicle"] = "이동 Vehicle Seat",
		...
		["bar5_1"] = "이동\nBar 5",
		["pet"] = "이동\nPet",
		["player"] = "이동 Playercastbar",
		["target"] = "이동 Targetcastbar",
		["classbar"] = "이동 Classbar",
		["raid"] = "이동 RaidUtility",
		["rcd"] = "이동 RaidCD",
