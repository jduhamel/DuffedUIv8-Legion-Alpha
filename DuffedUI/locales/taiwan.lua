...
if D.Client == "zhTW" then
	L["move"] = {
		...
		["shapeshift"] = "移動 Shapeshift/Totem",
		["achievements"] = "移動 Achievements",
		["roll"] = "移動 Loot Roll Frame",
		["vehicle"] = "移動 Vehicle Seat",
		...
		["bar5_1"] = "移動\nBar 5",
		["pet"] = "移動\nPet",
		["player"] = "移動 Playercastbar",
		["target"] = "移動 Targetcastbar",
		["classbar"] = "移動 Classbar",
		["raid"] = "移動 RaidUtility",
		["rcd"] = "移動 RaidCD",
