...
text4:SetFontObject("GameFontNormal")
...
sbt:SetFontObject("GameFontNormal")
...
--option1:SetFontObject("GameFontNormal")
...
--option2:SetFontObject("GameFontNormal")
...
local function install()
	...
	--option2.Text:SetText(L["buttons"]["install"])
	option1:SetText(L["buttons"]["tutorial"])
