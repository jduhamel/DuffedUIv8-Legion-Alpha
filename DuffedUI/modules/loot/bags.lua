...
function CreateReagentContainer()
	...
	SwitchBankButton:FontString("Text", C["media"].font, 10, "THINOUTLINE")
	...
	if C["bags"]["SortingButton"] then
		...
		SortButton:FontString("Text", C["media"].font, 10, "THINOUTLINE")
...
function CreateContainer(storagetype, ...)
	...
	if (storagetype == "Bag") then
		...
		if C["bags"]["SortingButton"] then
			...
			Sort:SkinButton()
			Sort:FontString("Text", C["media"].font, 10, "THINOUTLINE")
		...
		ToggleBagsContainer.Text:SetFont(C["media"].font, 10, "THINOUTLINE")
		...
		SwitchReagentButton:FontString("Text", C["media"].font, 10, "THINOUTLINE")
