...
local function LoadSkin()
	...
	EncounterJournal.backdrop:SetColorTexture(0, 0, 0)
	...
	EncounterJournal.backdrop2:SetColorTexture(unpack(C["media"].bordercolor))
	...
	EncounterJournal.backdrop3:SetColorTexture(0, 0, 0)
	...
	EncounterJournal:HookScript("OnShow", function()
		if not EncounterJournalEncounterFrameInfo.backdrop then
			...
			EncounterJournalEncounterFrameInfo.backdrop:SetColorTexture(0, 0, 0)
			...
			EncounterJournalEncounterFrameInfo.backdrop2:SetColorTexture(unpack(C["media"].bordercolor))
			...
			EncounterJournalEncounterFrameInfo.backdrop3:SetColorTexture(0, 0, 0)
